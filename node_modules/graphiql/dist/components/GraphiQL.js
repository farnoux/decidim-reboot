...
var fuzzyExtractOperationTitle_1 = require("../utility/fuzzyExtractOperationTitle");
var id_from_tab_contents_1 = require("../utility/id-from-tab-contents");
var guid_1 = require("../utility/guid");
...
var GraphiQL = (function (_super) {
    ...
    function GraphiQL(props) {
        ...
        _this.persistTabsState = function () {
            ...
            if (_this.props.tabs) {
                _this._storage.set('tabState', JSON.stringify(_this.state.tabs, function (key, value) {
                    return key === 'response' ||
                        (_this.state.shouldPersistHeaders && key === 'headers')
                        ? undefined
                        : value;
                }));
                if (typeof _this.props.tabs === 'object') {
                    (_b = (_a = _this.props.tabs).onTabChange) === null || _b === void 0 ? void 0 : _b.call(_a, _this.state.tabs);
                }
            }
        };
        _this.makeHandleOnSelectTab = function (index) { return function () {
            _this.handleStopQuery();
            _this.setState(function (state) { return stateOnSelectTabReducer(index, state); }, function () {
                _this.persistTabsState();
                if (_this.state.query) {
                    _this.handleEditQuery(_this.state.query);
                }
            });
        }; };
        _this.makeHandleOnCloseTab = function (index) { return function () {
            if (_this.state.tabs.activeTabIndex === index) {
                _this.handleStopQuery();
            }
            _this.setState(function (state) { return stateOnCloseTabReducer(index, state); }, _this.persistTabsState);
        }; };
        _this.handleOnAddTab = function () {
            _this.setState(function (state) { return stateOnTabAddReducer(state); }, _this.persistTabsState);
        };
                        ...
                        return [4, this._fetchQuery(editedQuery, variables, headers, operationName, shouldPersistHeaders, function (result) {
                                ...
                                if (queryID === _this._editorQueryID) {
                                    ...
                                    if (maybeMultipart) {
                                        ...
                                        try {
                                            for (var maybeMultipart_1 = __values(maybeMultipart), maybeMultipart_1_1 = maybeMultipart_1.next(); !maybeMultipart_1_1.done; maybeMultipart_1_1 = maybeMultipart_1.next()) {
                                                ...
                                                if (path) {
                                                    ...
                                                    set_value_1.default(payload.data, path, data, { merge: true });
                                                }
                                                else if (data) {
                                        ...
                                        var response_1 = GraphiQL.formatResult(result);
                                        _this.setState(function (state) { return (__assign(__assign({}, state), { tabs: __assign(__assign({}, state.tabs), { tabs: state.tabs.tabs.map(function (tab, index) {
                                                    if (index !== state.tabs.activeTabIndex) {
                                                        return tab;
                                                    }
                                                    return __assign(__assign({}, tab), { response: response_1 });
                                                }) }), isWaitingForResponse: false, response: response_1 })); }, _this.persistTabsState);
                                    }
                                }
                            })];
                    case 2:
        ...
        _this.handleEditQuery = debounce_1.default(100, function (value) {
            ...
            _this.setState(function (state) { return (__assign(__assign(__assign(__assign({}, state), { query: value }), queryFacts), { tabs: tabsStateEditQueryReducer(value, state.tabs, queryFacts === null || queryFacts === void 0 ? void 0 : queryFacts.operationName) })); }, _this.persistTabsState);
        ...
        _this._updateQueryFacts = function (query, operationName, prevOperations, schema) {
            var queryFacts = graphql_language_service_1.getOperationFacts(schema, query);
            if (queryFacts) {
        ...
        _this.handleEditVariables = function (value) {
            _this.setState(function (state) { return (__assign(__assign({}, state), { variables: value, tabs: tabsStateEditVariablesReducer(value, state.tabs) })); }, _this.persistTabsState);
        ...
        _this.handleEditHeaders = function (value) {
            _this.setState(function (state) { return (__assign(__assign({}, state), { headers: value, tabs: tabsStateEditHeadersReducer(value, state.tabs) })); }, _this.persistTabsState);
        ...
        var query = props.query !== undefined
            ...
            : _this._storage.get('query')
                ...
                : props.defaultQuery !== undefined
                    ? props.defaultQuery
                    : defaultQuery;
        var queryFacts = graphql_language_service_1.getOperationFacts(props.schema, query);
        ...
        _this._introspectionQuery = graphql_1.getIntrospectionQuery({
            schemaDescription: (_f = props.schemaDescription) !== null && _f !== void 0 ? _f : undefined,
            inputValueDeprecation: (_g = props.inputValueDeprecation) !== null && _g !== void 0 ? _g : undefined,
        });
        _this._introspectionQueryName = (_h = props.introspectionQueryName) !== null && _h !== void 0 ? _h : introspectionQueries_1.introspectionQueryName;
        _this._introspectionQuerySansSubscriptions = _this._introspectionQuery.replace('subscriptionType { name }', '');
        var initialTabHash = id_from_tab_contents_1.idFromTabContents({
            query: query,
            variables: variables,
            headers: headers,
        });
        ...
        if (rawTabState === null) {
            ...
            try {
                for (var _k = __values(tabsState.tabs), _l = _k.next(); !_l.done; _l = _k.next()) {
                    var tab = _l.value;
                    tab.query = tab.query;
                    ...
                    tab.id = guid_1.guid();
                    tab.hash = id_from_tab_contents_1.idFromTabContents(tab);
        ...
        var index = 0;
        try {
            for (var _m = __values(tabsState.tabs), _o = _m.next(); !_o.done; _o = _m.next()) {
                var tab = _o.value;
                if (tab.hash === initialTabHash) {
        ...
        _this.state = __assign({ tabs: tabsState, schema: schema, query: activeTab === null || activeTab === void 0 ? void 0 : activeTab.query, variables: activeTab === null || activeTab === void 0 ? void 0 : activeTab.variables, headers: activeTab === null || activeTab === void 0 ? void 0 : activeTab.headers, operationName: activeTab === null || activeTab === void 0 ? void 0 : activeTab.operationName, response: (_j = activeTab === null || activeTab === void 0 ? void 0 : activeTab.response) !== null && _j !== void 0 ? _j : response, docExplorerOpen: docExplorerOpen,
            schemaErrors: schemaErrors, editorFlex: Number(_this._storage.get('editorFlex')) || 1, secondaryEditorOpen: secondaryEditorOpen, secondaryEditorHeight: Number(_this._storage.get('secondaryEditorHeight')) || 200, variableEditorActive: _this._storage.get('variableEditorActive') === 'true' ||
        ...
        return (react_1.default.createElement("div", { ref: function (n) {
            ...
            react_1.default.createElement("div", { className: "editorWrap" },
                ...
                this.props.tabs ? (react_1.default.createElement(Tabs_1.Tabs, { tabsProps: {
                    ...
                    tabsState.tabs.map(function (tab, index) { return (react_1.default.createElement(Tabs_1.Tab, { key: tab.id, isActive: index === tabsState.activeTabIndex, title: tab.title, isCloseable: tabsState.tabs.length > 1, onSelect: _this.makeHandleOnSelectTab(index), onClose: _this.makeHandleOnCloseTab(index), tabProps: {
                            'aria-controls': 'sessionWrap',
                            id: "session-tab-" + index,
                        } })); }),
                    react_1.default.createElement(Tabs_1.TabAddButton, { onClick: this.handleOnAddTab }))) : null,
                react_1.default.createElement("div", { ref: function (n) {
                        _this.editorBarComponent = n;
                    }, role: "tabpanel", id: "sessionWrap", className: "editorBar", "aria-labelledby": "session-tab-" + tabsState.activeTabIndex, onDoubleClick: this.handleResetResize, onMouseDown: this.handleResizeStart },
                    react_1.default.createElement("div", { className: "queryWrap", style: queryWrapStyle },
                        ...
                        react_1.default.createElement("section", { className: "variable-editor secondary-editor", style: secondaryEditorStyle, "aria-label": this.state.variableEditorActive
                            ...
                            react_1.default.createElement("div", { className: "secondary-editor-title variable-editor-title", id: "secondary-editor-title", style: {
                                ...
                                react_1.default.createElement("div", { className: "variable-editor-title-text" + (this.state.variableEditorActive ? ' active' : ''), onClick: this.handleOpenVariableEditorTab, onMouseDown: this.handleTabClickPropogation }, 'Query Variables'),
                                this.state.headerEditorEnabled && (react_1.default.createElement("div", { style: {
                                        marginLeft: '20px',
                                    }, className: "variable-editor-title-text" + (this.state.headerEditorActive ? ' active' : ''), onClick: this.handleOpenHeaderEditorTab, onMouseDown: this.handleTabClickPropogation }, 'Request Headers'))),
    ...
    GraphiQL.prototype.fetchSchema = function () {
        ...
        fetch
            ...
            if (result && result.data && '__schema' in (result === null || result === void 0 ? void 0 : result.data)) {
                ...
                if (schema) {
                    var queryFacts = graphql_language_service_1.getOperationFacts(schema, _this.state.query);
                    _this.safeSetState(__assign(__assign({ schema: schema }, queryFacts), { schemaErrors: undefined }));
                    (_b = (_a = _this.props).onSchemaChange) === null || _b === void 0 ? void 0 : _b.call(_a, schema);
                }
            }
            else {
                ...
                return [2, Promise.resolve(fetch)
                        ...
                        if (isObservable(value)) {
                            ...
                            (function () { return __awaiter(_this, void 0, void 0, function () {
                                var value_1, value_1_1, result, e_4_1, error_2;
                                var e_4, _a;
...
function tabsStateEditHeadersReducer(value, state) {
    return __assign(__assign({}, state), { tabs: state.tabs.map(function (tab, index) {
            if (index !== state.activeTabIndex) {
                return tab;
            }
            return __assign(__assign({}, tab), { headers: value, hash: id_from_tab_contents_1.idFromTabContents({
                    query: tab.query,
                    headers: value,
...
function tabsStateEditVariablesReducer(value, state) {
    return __assign(__assign({}, state), { tabs: state.tabs.map(function (tab, index) {
            ...
            return __assign(__assign({}, tab), { variables: value, hash: id_from_tab_contents_1.idFromTabContents({
                    query: tab.query,
                    headers: tab.headers,
                    variables: value,
                }) });
...
function tabsStateEditQueryReducer(value, state, operationName) {
    return __assign(__assign({}, state), { tabs: state.tabs.map(function (tab, index) {
            ...
            return __assign(__assign({}, tab), { title: operationName !== null && operationName !== void 0 ? operationName : fuzzyExtractOperationTitle_1.fuzzyExtractOperationTitle(value), query: value, hash: id_from_tab_contents_1.idFromTabContents({
                    query: value,
                    headers: tab.headers,
                    variables: tab.variables,
                }) });
...
function stateOnSelectTabReducer(index, state) {
    ...
    var tabs = state.tabs.tabs.map(function (currentTab, tabIndex) {
        ...
        return __assign(__assign({}, currentTab), { query: state.query, variables: state.variables, operationName: state.operationName, headers: state.headers, response: state.response, hash: id_from_tab_contents_1.idFromTabContents({
                query: state.query,
    ...
    return __assign(__assign({}, state), { query: newActiveTab.query, variables: newActiveTab.variables, operationName: newActiveTab.operationName, headers: newActiveTab.headers, response: newActiveTab.response, tabs: __assign(__assign({}, state.tabs), { tabs: tabs, activeTabIndex: index }) });
}
function stateOnCloseTabReducer(index, state) {
    ...
    var newTabsState = __assign(__assign({}, state.tabs), { activeTabIndex: newActiveTabIndex, tabs: state.tabs.tabs.filter(function (_tab, i) { return index !== i; }) });
    var activeTab = newTabsState.tabs[newActiveTabIndex];
    return __assign(__assign({}, state), { query: activeTab.query, variables: activeTab.variables, operationName: activeTab.operationName, headers: activeTab.headers, response: activeTab.response, tabs: newTabsState });
}
function stateOnTabAddReducer(state) {
    ...
    var newTab = {
        ...
        operationName: '',
        response: '',
        hash: id_from_tab_contents_1.idFromTabContents({
            query: '',
            variables: '',
            headers: '',
        }),
    ...
    var tabs = state.tabs.tabs.map(function (tab, index) {
        ...
        return __assign(__assign({}, tab), { headers: state.headers, variables: state.variables, query: state.query, operationName: state.operationName, response: state.response });
    });
    return __assign(__assign({}, state), { headers: newTab.headers, variables: newTab.variables, query: newTab.query, operationName: newTab.operationName, response: newTab.response, tabs: __assign(__assign({}, state.tabs), { activeTabIndex: state.tabs.tabs.length, tabs: __spread(tabs, [newTab]) }) });
}
