        ...
        return (React.createElement("div", { ref: function (n) {
            ...
            React.createElement("div", { className: "editorWrap" },
                ...
                this.props.tabs ? (React.createElement(Tabs, { tabsProps: {
                    ...
                    tabsState.tabs.map(function (tab, index) { return (React.createElement(Tab, { key: tab.id, isActive: index === tabsState.activeTabIndex, title: tab.title, isCloseable: tabsState.tabs.length > 1, onSelect: _this.makeHandleOnSelectTab(index), onClose: _this.makeHandleOnCloseTab(index), tabProps: {
                            'aria-controls': 'sessionWrap',
                            id: "session-tab-" + index,
                        } })); }),
                    React.createElement(TabAddButton, { onClick: this.handleOnAddTab }))) : null,
                    ...
                    React.createElement("div", { className: "queryWrap", style: queryWrapStyle },
                        ...
                        React.createElement("section", { className: "variable-editor secondary-editor", style: secondaryEditorStyle, "aria-label": this.state.variableEditorActive
                            ...
                            React.createElement("div", { className: "secondary-editor-title variable-editor-title", id: "secondary-editor-title", style: {
                                ...
                                React.createElement("div", { className: "variable-editor-title-text" + (this.state.variableEditorActive ? ' active' : ''), onClick: this.handleOpenVariableEditorTab, onMouseDown: this.handleTabClickPropogation }, 'Query Variables'),
...
function tabsStateEditHeadersReducer(value, state) {
    return __assign(__assign({}, state), { tabs: state.tabs.map(function (tab, index) {
            ...
            return __assign(__assign({}, tab), { headers: value, hash: idFromTabContents({
                    query: tab.query,
                    headers: value,
...
function tabsStateEditVariablesReducer(value, state) {
    return __assign(__assign({}, state), { tabs: state.tabs.map(function (tab, index) {
            ...
            return __assign(__assign({}, tab), { variables: value, hash: idFromTabContents({
                    query: tab.query,
                    headers: tab.headers,
                    variables: value,
                }) });
...
function tabsStateEditQueryReducer(value, state, operationName) {
    return __assign(__assign({}, state), { tabs: state.tabs.map(function (tab, index) {
            ...
            return __assign(__assign({}, tab), { title: operationName !== null && operationName !== void 0 ? operationName : fuzzyExtractOperationTitle(value), query: value, hash: idFromTabContents({
                    query: value,
                    headers: tab.headers,
                    variables: tab.variables,
                }) });
...
function stateOnSelectTabReducer(index, state) {
    ...
    var tabs = state.tabs.tabs.map(function (currentTab, tabIndex) {
        ...
        return __assign(__assign({}, currentTab), { query: state.query, variables: state.variables, operationName: state.operationName, headers: state.headers, response: state.response, hash: idFromTabContents({
                query: state.query,
